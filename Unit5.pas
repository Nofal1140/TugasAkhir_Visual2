...
zqry1.SQL.Add('insert into siswa values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+edt7.Text+'","'+edt8.Text+'","'+edt9.Text+'","'+edt10.Text+'","'+edt11.Text+'")');
zqry1.ExecSQL ;
...
ShowMessage('DATA BERHASIL DIUPDATE!'); //UPDATE
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update siswa set nis= "'+edt1.Text+'",nisn="'+edt2.Text+'" where id="'+id+'"');
  zqry1.ExecSQL;
...
edt11.Text:= zqry1.FieldList[8].AsString;
