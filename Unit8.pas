...
zqry1.SQL.Add('insert into org_tua values(null,"'+edt1.Text+'","'+edt2.Text+'","'+edt3.Text+'","'+edt4.Text+'","'+edt5.Text+'","'+edt6.Text+'","'+edt7.Text+'","'+edt8.Text+'","'+edt9.Text+'","'+edt10.Text+'")');
zqry1.ExecSQL ;

zqry1.SQL.Clear;
zqry1.SQL.Add('select * from org_tua');
zqry1.Open;
...
ShowMessage('DATA BERHASIL DIUPDATE!'); //UPDATE
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update org_tua set nik= "'+edt1.Text+'",nama="'+edt2.Text+'" where id="'+id+'"');
  zqry1.ExecSQL;
...
edt9.Text:= zqry1.FieldList[6].AsString;
...
begin
zqry1.SQL.Clear;
zqry1.SQL.Add(' delete from org_tua where id="'+id+'"');
zqry1.ExecSQL;
zqry1.SQL.Clear;
zqry1.SQL.Add('select * from org_tua');
zqry1.Open;
